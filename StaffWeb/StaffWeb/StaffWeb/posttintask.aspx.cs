        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                */
                ...
                DataSet dbduplicated = DBConn.RunSelectQuery("select * from [TaskDetail] where TaskType=@tasktype and TaskID=@taskid and CUS=@cus and NUS=@nus and Quantity=@quantity and  RutaAbastecimiento=@RutaAbastecimiento",
                    new string[]{
                        "@tasktype", 
                        "@taskid", 
                        "@cus", 
